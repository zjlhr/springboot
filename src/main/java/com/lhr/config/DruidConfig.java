...
/**
 * 注： - @EnableConfigurationProperties({DruidDataSourceProperties.class})
 * 用于导入上一步Druid的配置信息 - public ServletRegistrationBean druidServlet() 相当于Web
 * Servlet配置 - public FilterRegistrationBean filterRegistrationBean() 相当于Web
 * Filter配置
 * 
